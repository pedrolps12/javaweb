                                    ...
                                    <c:forEach items="${categories}" var="category">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center col-xs-2">
                                                <div class="btn-group">
                                                    <a class="btn btn-xs btn-warning" href="Categorias?action=edit&id=<c:out value="${category.id}"/>">Modificar</a>
                                                    <button class="btn btn-xs btn-danger openModal" prop1="<c:out value="${category.id}"/>" href="#"  name="openModal">Eliminar</button>
